...
# --- KONFIGURASI LEVEL ---
@export var next_level_path: String = "res://scene/coming_soon.tscn" 
...
func _ready():
	...
	elif "lvl_3.tscn" in current_scene_file:
		# Path orc yang kamu kirim tadi
		path_gambar = "res://arts/sprites/objects/orc.png"
